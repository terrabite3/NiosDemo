...
# Memory: nios_ram
MEM_0 := QsysDemo_nios_ram
$(MEM_0)_NAME := nios_ram
...
$(MEM_0)_HIERARCHICAL_PATH := nios_ram
$(MEM_0)_WIDTH := 32
...
.PHONY: nios_ram
nios_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
